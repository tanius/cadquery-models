...
# A parametric, cuboid case made from six overlapping wall panels. Also demonstrates how custom 
# CadQuery parts can be called with a CadQuery plugin in a generic way.
...
def part(self, part_class, measures):
    ...
    :param part_class: Type identifier of your class used to create your custom part.
